# Boss du Palier 17 - Celestial Chimera Guardian

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 17. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 18.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 170,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 27
- **Hit Points (HP)** : 700,927 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 525
- **Agilité (AGI)** : 399
- **EXP Donnée** : 70,092 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 17.
