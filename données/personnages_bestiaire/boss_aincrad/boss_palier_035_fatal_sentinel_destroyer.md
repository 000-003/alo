# Boss du Palier 35 - Fatal Sentinel Destroyer

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 35. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 36.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 350,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 45
- **Hit Points (HP)** : 2,070,627 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 975
- **Agilité (AGI)** : 772
- **EXP Donnée** : 207,062 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 35.
