# Boss du Palier 80 - Abyssal Reaper Lord

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 80. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 81.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 800,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 90
- **Hit Points (HP)** : 7,155,417 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 2100
- **Agilité (AGI)** : 607
- **EXP Donnée** : 715,541 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 80.
