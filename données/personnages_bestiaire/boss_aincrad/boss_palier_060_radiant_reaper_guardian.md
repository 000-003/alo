# Boss du Palier 60 - Radiant Reaper Guardian

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 60. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 61.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 600,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 70
- **Hit Points (HP)** : 4,647,580 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 1600
- **Agilité (AGI)** : 772
- **EXP Donnée** : 464,758 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 60.
