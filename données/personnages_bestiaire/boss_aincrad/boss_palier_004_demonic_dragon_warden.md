# Boss du Palier 4 - Demonic Dragon Warden

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 4. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 5.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 40,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 14
- **Hit Points (HP)** : 80,000 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 200
- **Agilité (AGI)** : 729
- **EXP Donnée** : 8,000 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 4.
