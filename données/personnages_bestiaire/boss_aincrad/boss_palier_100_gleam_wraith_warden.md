# Boss du Palier 100 - Gleam Wraith Warden

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 100. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 101.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 1,000,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 110
- **Hit Points (HP)** : 10,000,000 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 2600
- **Agilité (AGI)** : 402
- **EXP Donnée** : 1,000,000 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 100.
