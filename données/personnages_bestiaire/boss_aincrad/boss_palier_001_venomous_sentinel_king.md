# Boss du Palier 1 - Venomous Sentinel King

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 1. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 2.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 10,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 11
- **Hit Points (HP)** : 10,000 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 125
- **Agilité (AGI)** : 298
- **EXP Donnée** : 1,000 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 1.
