# Boss du Palier 10 - Skull Kobold Guardian

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 10. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 11.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 100,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 20
- **Hit Points (HP)** : 316,227 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 350
- **Agilité (AGI)** : 346
- **EXP Donnée** : 31,622 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 10.
