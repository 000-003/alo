# Boss du Palier 96 - Shadow Arachnid Destroyer

## 1. Lore et Profil Procédural
L'anomalie gardienne du labyrinthe du palier 96. Modélisé par le moteur Cardinal pour tester les limites des joueurs. Ses données ont été croisées avec des mythes terriens pour lui donner une apparence unique. Il bloque l'accès aux escaliers menant au palier 97.

## 2. Statistiques de Combat RPG
- **Prime (Bounty System)** : 960,000 Yrds (Distribuée au groupe)
- **Catégorie** : Floor Boss (Unique)
- **Niveau** : 106
- **Hit Points (HP)** : 9,406,040 (Divisé en 4 Barres de Vie)
- **Force (STR)** : 2500
- **Agilité (AGI)** : 243
- **EXP Donnée** : 940,604 Points d'Expérience

## 3. Paramètres de Salle et Apparition
- **Zone d'Apparition** : Labyrinthe Principal, Salle scellée du Palier 96.
...
- **Faiblesses** : Ténèbres (+30% Dégâts)
- **Résistances** : Absorption de Magie
