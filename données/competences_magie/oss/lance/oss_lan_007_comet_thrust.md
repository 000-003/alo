...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_LAN_007` puis `!cast comet_thrust` en combat

## Lore (Encyclopédie d'Argo)
Un estoc bondissant traçant une traînée de comète.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_LAN_007')`
