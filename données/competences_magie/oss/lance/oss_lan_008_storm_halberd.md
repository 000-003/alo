...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_LAN_008` puis `!cast storm_halberd` en combat

## Lore (Encyclopédie d'Argo)
Un moulinet de hallebarde suivi d’un estoc foudroyant.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_LAN_008')`
