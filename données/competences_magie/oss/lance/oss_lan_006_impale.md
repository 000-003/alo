...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_LAN_006` puis `!cast impale` en combat

## Lore (Encyclopédie d'Argo)
Un empalement puissant qui cloue les grandes créatures sur place.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_LAN_006')`
