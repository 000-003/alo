...
- **Déblocage** : Maîtrise **Avancé** + **quête** de compétence
- **Commande** : `!learn_skill OSS_LAN_009` puis `!cast wyvern_fall` en combat

## Lore (Encyclopédie d'Argo)
Un piqué aérien lance en avant qui transperce à l’atterrissage ; débloqué par quête.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_LAN_009')`
