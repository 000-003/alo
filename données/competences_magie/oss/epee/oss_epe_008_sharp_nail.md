...
- **Déblocage** : Maîtrise d’arme Épée à une main au rang **Confirmé**
- **Commande** : `!learn_skill OSS_EPE_008` puis `!cast sharp_nail` en combat

## Lore (Encyclopédie d'Argo)
Une série de coups ascendants en griffe qui déchirent la garde adverse.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EPE_008')`
