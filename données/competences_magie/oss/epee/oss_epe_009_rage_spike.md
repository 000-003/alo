...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Ferra `NPC_GAT_31`
- **Commande** : `!learn_skill OSS_EPE_009` puis `!cast rage_spike` en combat

## Lore (Encyclopédie d'Argo)
Un estoc rageur suivi d’une secousse de choc, popularisé sur les fronts de New Aincrad.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EPE_009')`
