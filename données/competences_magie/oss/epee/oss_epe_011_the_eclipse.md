...
- **Déblocage** : Maîtrise **Avancé** + **quête** de compétence
- **Commande** : `!learn_skill OSS_EPE_011` puis `!cast the_eclipse` en combat

## Lore (Encyclopédie d'Argo)
Un déluge de coups si dense qu’il masque le lanceur ; réservé aux maîtres avancés après quête.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EPE_011')`
