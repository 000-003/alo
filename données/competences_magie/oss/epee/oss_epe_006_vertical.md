...
- **Déblocage** : Maîtrise d’arme Épée à une main au rang **Novice**
- **Commande** : `!learn_skill OSS_EPE_006` puis `!cast vertical` en combat

## Lore (Encyclopédie d'Argo)
Une frappe verticale descendante, simple et fiable.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EPE_006')`
