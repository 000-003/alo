...
- **Déblocage** : Maîtrise **Avancé** + **quête** de compétence
- **Commande** : `!learn_skill OSS_EPE_012` puis `!cast nova_ascension` en combat

## Lore (Encyclopédie d'Argo)
Une ascension fulgurante ponctuée d’une frappe descendante en gerbe d’étincelles.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EPE_012')`
