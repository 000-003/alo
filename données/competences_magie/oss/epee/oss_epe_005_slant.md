...
- **Déblocage** : Maîtrise d’arme Épée à une main au rang **Novice**
- **Commande** : `!learn_skill OSS_EPE_005` puis `!cast slant` en combat

## Lore (Encyclopédie d'Argo)
Une coupe diagonale rapide, deuxième réflexe de tout épéiste débutant.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EPE_005')`
