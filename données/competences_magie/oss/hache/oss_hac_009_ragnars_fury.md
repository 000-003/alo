...
- **Déblocage** : Maîtrise **Avancé** + **quête** de compétence
- **Commande** : `!learn_skill OSS_HAC_009` puis `!cast ragnars_fury` en combat

## Lore (Encyclopédie d'Argo)
La furie du Roi Béhémoth Ragnar canalisée en un déluge de coups ; débloquée par quête.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_HAC_009')`
