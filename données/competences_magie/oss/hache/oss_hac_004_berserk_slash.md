...
- **Déblocage** : Maîtrise d’arme Hache au rang **Confirmé**
- **Commande** : `!learn_skill OSS_HAC_004` puis `!cast berserk_slash` en combat

## Lore (Encyclopédie d'Argo)
Une série de coups sauvages échangeant la défense contre la puissance.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_HAC_004')`
