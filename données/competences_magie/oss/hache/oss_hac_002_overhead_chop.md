...
- **Déblocage** : Maîtrise d’arme Hache au rang **Novice**
- **Commande** : `!learn_skill OSS_HAC_002` puis `!cast overhead_chop` en combat

## Lore (Encyclopédie d'Argo)
Un abattage vertical de toute la force des bras.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_HAC_002')`
