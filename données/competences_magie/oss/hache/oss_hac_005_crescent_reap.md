...
- **Déblocage** : Maîtrise d’arme Hache au rang **Confirmé**
- **Commande** : `!learn_skill OSS_HAC_005` puis `!cast crescent_reap` en combat

## Lore (Encyclopédie d'Argo)
Une fauche en croissant large qui frappe deux ennemis.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_HAC_005')`
