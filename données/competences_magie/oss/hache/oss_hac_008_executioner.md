...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_HAC_008` puis `!cast executioner` en combat

## Lore (Encyclopédie d'Argo)
Une exécution en deux temps dévastatrice sur cible affaiblie.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_HAC_008')`
