...
- **Déblocage** : Maîtrise **Avancé** + **quête** de compétence
- **Commande** : `!learn_skill OSS_DAG_009` puis `!cast assassinate` en combat

## Lore (Encyclopédie d'Argo)
Une exécution silencieuse aux dégâts massifs sur cible affaiblie ; débloquée par quête.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_DAG_009')`
