...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_DAG_008` puis `!cast serpent_coil` en combat

## Lore (Encyclopédie d'Argo)
Un enchaînement sinueux de six coups imprévisibles.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_DAG_008')`
