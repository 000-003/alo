...
- **Déblocage** : Maîtrise d’arme Dague au rang **Novice**
- **Commande** : `!learn_skill OSS_DAG_002` puis `!cast fell_crescent` en combat

## Lore (Encyclopédie d'Argo)
Une entaille bondissante en croissant, première arme des lames furtives.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_DAG_002')`
