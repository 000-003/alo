...
| Niveau Requis | 24 |
| Déblocage | Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69` |
...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_DAG_006` puis `!cast shadow_stitch` en combat

## Lore (Encyclopédie d'Argo)
Cloue l’ombre de la cible d’une lame pour l’immobiliser un instant.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_DAG_006')`
