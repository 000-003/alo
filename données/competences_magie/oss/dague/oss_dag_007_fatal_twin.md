...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_DAG_007` puis `!cast fatal_twin` en combat

## Lore (Encyclopédie d'Argo)
Deux dagues frappant simultanément deux points vitaux.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_DAG_007')`
