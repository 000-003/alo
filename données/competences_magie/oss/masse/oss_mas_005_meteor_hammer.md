...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_MAS_005` puis `!cast meteor_hammer` en combat

## Lore (Encyclopédie d'Argo)
Un coup tournoyant lancé comme une météorite au bout de sa chaîne.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_MAS_005')`
