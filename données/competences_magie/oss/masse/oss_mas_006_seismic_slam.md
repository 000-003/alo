...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_MAS_006` puis `!cast seismic_slam` en combat

## Lore (Encyclopédie d'Argo)
Un impact sismique qui soulève et renverse les ennemis au sol.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_MAS_006')`
