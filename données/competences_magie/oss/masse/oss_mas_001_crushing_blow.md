...
- **Déblocage** : Maîtrise d’arme Masse au rang **Novice**
- **Commande** : `!learn_skill OSS_MAS_001` puis `!cast crushing_blow` en combat

## Lore (Encyclopédie d'Argo)
Un coup d’écrasement de base qui ignore une part de l’armure.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_MAS_001')`
