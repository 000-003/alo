...
| Niveau Requis | 12 |
| Déblocage | Maîtrise d’arme Masse au rang **Confirmé** |
...
- **Déblocage** : Maîtrise d’arme Masse au rang **Confirmé**
- **Commande** : `!learn_skill OSS_MAS_004` puis `!cast concussion` en combat

## Lore (Encyclopédie d'Argo)
Un coup à la tête qui étourdit et brouille l’ennemi.
