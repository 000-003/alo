...
- **Déblocage** : Maîtrise d’arme Armes de jet au rang **Confirmé**
- **Commande** : `!learn_skill OSS_JET_003` puis `!cast ricochet` en combat

## Lore (Encyclopédie d'Argo)
Une lame qui rebondit d’une cible à l’autre.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_JET_003')`
