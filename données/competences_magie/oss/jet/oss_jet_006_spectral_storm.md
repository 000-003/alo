...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_JET_006` puis `!cast spectral_storm` en combat

## Lore (Encyclopédie d'Argo)
Une tempête de lames spectrales saturant une zone.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_JET_006')`
