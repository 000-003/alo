...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_JET_005` puis `!cast homing_blade` en combat

## Lore (Encyclopédie d'Argo)
Une lame guidée qui corrige sa trajectoire vers la cible marquée.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_JET_005')`
