...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_RAP_007` puis `!cast neige` en combat

## Lore (Encyclopédie d'Argo)
« Neige » : une volée d’estocs légers et froids qui saturent la garde.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_RAP_007')`
