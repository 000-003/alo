...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_RAP_009` puis `!cast rosiers_thorn` en combat

## Lore (Encyclopédie d'Argo)
Un estoc empoisonné en épine de rosier qui perce et affaiblit.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_RAP_009')`
