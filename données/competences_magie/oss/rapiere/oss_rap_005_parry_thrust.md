...
- **Déblocage** : Maîtrise d’arme Rapière au rang **Confirmé**
- **Commande** : `!learn_skill OSS_RAP_005` puis `!cast parry_thrust` en combat

## Lore (Encyclopédie d'Argo)
Une parade suivie d’une riposte immédiate au point faible.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_RAP_005')`
