...
| Niveau Requis | 12 |
| Déblocage | Maîtrise d’arme Rapière au rang **Confirmé** |
...
- **Déblocage** : Maîtrise d’arme Rapière au rang **Confirmé**
- **Commande** : `!learn_skill OSS_RAP_006` puis `!cast quadruple_pain` en combat

## Lore (Encyclopédie d'Argo)
Quatre estocs successifs au même point, spécialité des tireurs de Lioda.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_RAP_006')`
