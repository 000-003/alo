...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Roan `NPC_ALN_69`
- **Commande** : `!learn_skill OSS_RAP_008` puis `!cast crescendo` en combat

## Lore (Encyclopédie d'Argo)
Une montée d’estocs de plus en plus rapides jusqu’au coup final.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_RAP_008')`
