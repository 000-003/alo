...
- **Déblocage** : Maîtrise d’arme Arc au rang **Confirmé**
- **Commande** : `!learn_skill OSS_ARC_005` puis `!cast piercing_arrow` en combat

## Lore (Encyclopédie d'Argo)
Une flèche qui traverse une ligne d’ennemis alignés.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_005')`
