...
- **Déblocage** : Maîtrise d’arme Arc au rang **Novice**
- **Commande** : `!learn_skill OSS_ARC_003` puis `!cast aimed_shot` en combat

## Lore (Encyclopédie d'Argo)
Un tir soigneusement visé aux dégâts accrus sur point faible.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_003')`
