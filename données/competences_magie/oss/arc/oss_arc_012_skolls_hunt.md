...
- **Déblocage** : Maîtrise **Avancé** + **quête spéciale** (cf. Starburst Stream)
- **Commande** : `!learn_skill OSS_ARC_012` puis `!cast skolls_hunt` en combat

## Lore (Encyclopédie d'Argo)
La chasse du loup Sköll : une nuée de flèches traquant chaque ennemi ; titre-quête des maîtres de l’arc.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_012')`
