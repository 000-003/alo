...
- **Déblocage** : Maîtrise d’arme Arc au rang **Confirmé**
- **Commande** : `!learn_skill OSS_ARC_006` puis `!cast arrow_rain` en combat

## Lore (Encyclopédie d'Argo)
Une volée en cloche qui pleut sur une petite zone.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_006')`
