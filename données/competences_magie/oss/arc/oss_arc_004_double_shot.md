...
- **Déblocage** : Maîtrise d’arme Arc au rang **Novice**
- **Commande** : `!learn_skill OSS_ARC_004` puis `!cast double_shot` en combat

## Lore (Encyclopédie d'Argo)
Deux flèches encochées et tirées d’un même geste.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_004')`
