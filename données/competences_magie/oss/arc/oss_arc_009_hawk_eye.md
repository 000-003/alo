...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Zephyrine `NPC_ALN_68`
- **Commande** : `!learn_skill OSS_ARC_009` puis `!cast hawk_eye` en combat

## Lore (Encyclopédie d'Argo)
Un tir de précision extrême sur cible lointaine, spécialité Cait Sith.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_009')`
