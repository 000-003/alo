...
- **Déblocage** : Maîtrise **Avancé** + **quête** de compétence
- **Commande** : `!learn_skill OSS_ARC_011` puis `!cast star_fall` en combat

## Lore (Encyclopédie d'Argo)
Une unique flèche tirée si haut qu’elle retombe en trait d’étoile filante.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_011')`
