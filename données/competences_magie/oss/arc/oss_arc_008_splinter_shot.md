...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Zephyrine `NPC_ALN_68`
- **Commande** : `!learn_skill OSS_ARC_008` puis `!cast splinter_shot` en combat

## Lore (Encyclopédie d'Argo)
Une flèche qui éclate en esquilles frappant plusieurs cibles.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_ARC_008')`
