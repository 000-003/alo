...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Ferra `NPC_GAT_31`
- **Commande** : `!learn_skill OSS_KAT_009` puis `!cast setsugekka` en combat

## Lore (Encyclopédie d'Argo)
« Neige-Lune-Fleur » : trois coupes esthétiques et mortelles enchaînées.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_KAT_009')`
