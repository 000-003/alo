...
- **Déblocage** : Maîtrise d’arme Katana au rang **Confirmé**
- **Commande** : `!learn_skill OSS_KAT_006` puis `!cast zangetsu` en combat

## Lore (Encyclopédie d'Argo)
Une coupe de lune tranchante en arc montant.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_KAT_006')`
