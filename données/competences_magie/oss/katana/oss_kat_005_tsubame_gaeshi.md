...
- **Déblocage** : Maîtrise d’arme Katana au rang **Confirmé**
- **Commande** : `!learn_skill OSS_KAT_005` puis `!cast tsubame_gaeshi` en combat

## Lore (Encyclopédie d'Argo)
« Retour de l’Hirondelle » : deux coupes si proches qu’elles semblent simultanées.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_KAT_005')`
