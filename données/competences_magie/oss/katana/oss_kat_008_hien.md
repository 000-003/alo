...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Ferra `NPC_GAT_31`
- **Commande** : `!learn_skill OSS_KAT_008` puis `!cast hien` en combat

## Lore (Encyclopédie d'Argo)
« Hirondelle Volante » : un bond-coupe d’une vélocité déconcertante.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_KAT_008')`
