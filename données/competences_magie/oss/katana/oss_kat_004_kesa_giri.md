...
- **Déblocage** : Maîtrise d’arme Katana au rang **Novice**
- **Commande** : `!learn_skill OSS_KAT_004` puis `!cast kesa_giri` en combat

## Lore (Encyclopédie d'Argo)
Une coupe diagonale de l’épaule à la hanche, geste fondateur du sabre.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_KAT_004')`
