...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_EP2_007` puis `!cast guillotine` en combat

## Lore (Encyclopédie d'Argo)
Un abattage vertical décisif visant la nuque des grandes créatures.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EP2_007')`
