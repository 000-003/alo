...
- **Déblocage** : Maîtrise d’arme Épée à deux mains au rang **Confirmé**
- **Commande** : `!learn_skill OSS_EP2_005` puis `!cast cascade` en combat

## Lore (Encyclopédie d'Argo)
Trois coups descendants en cascade qui écrasent la garde.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EP2_005')`
