...
- **Déblocage** : Maîtrise **Confirmé** + entraînement auprès de Vork `NPC_VOU_29`
- **Commande** : `!learn_skill OSS_EP2_006` puis `!cast mountain_splitter` en combat

## Lore (Encyclopédie d'Argo)
Une frappe verticale colossale, dit-on capable de fendre un rocher.

## Commande IA
- `SYS_GRANT_OSS(Avatar_ID, 'OSS_EP2_006')`
