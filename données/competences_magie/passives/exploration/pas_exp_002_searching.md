...
## Rangs
| Rang | Bonus (détection d’objets cachés) | Condition d'acquisition |
|---|---|---|
...
## Effet
Améliore passivement : **détection d’objets cachés**. Le bonus s'applique en permanence tant que la passive est équipée, sans coût de MP ni de stamina.

## Acquisition (Enseignement)
- **Rang I** : `!learn_skill PAS_EXP_002` auprès d'un formateur de Exploration (SKILL_MASTER de capitale) ou par pratique répétée.
- **Rangs II-III** : progression d'usage automatique ; rang III peut requérir une quête de maîtrise.

## Lore (Encyclopédie d'Argo)
Repérer coffres, leviers et trappes que les autres piétinent sans voir.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_EXP_002', Rang)`
