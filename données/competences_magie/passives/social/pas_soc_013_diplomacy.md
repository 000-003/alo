...
## Effet
Améliore passivement : **réduction de l’hostilité**. Le bonus s'applique en permanence tant que la passive est équipée, sans coût de MP ni de stamina.

## Acquisition (Enseignement)
- **Rang I** : `!learn_skill PAS_SOC_013` auprès d'un formateur de Social (SKILL_MASTER de capitale) ou par pratique répétée.
...
## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_SOC_013', Rang)`
