...
## Rangs
| Rang | Bonus (maîtrise de la rapière) | Condition d'acquisition |
|---|---|---|
...
## Effet
Améliore passivement : **maîtrise de la rapière**. Le bonus s'applique en permanence tant que la passive est équipée, sans coût de MP ni de stamina.

## Acquisition (Enseignement)
- **Rang I** : `!learn_skill PAS_CBT_010` auprès d'un formateur de Combat (SKILL_MASTER de capitale) ou par pratique répétée.
- **Rangs II-III** : progression d'usage automatique ; rang III peut requérir une quête de maîtrise.

## Lore (Encyclopédie d'Argo)
La pointe trouve toujours la faille chez qui maîtrise vraiment l’estoc.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_010', Rang)`
