...
## Incantation
*Le joueur tape `!cast spark` pour lancer le sort.*

## Acquisition (Enseignement)
- **Enseignant** : École de la Foudre de Voulg, maître Vork `NPC_VOU_29`
- **Prix d'apprentissage** : 150 Yrds (≈ 50 % d’un équipement T1)
- **Commande** : `!learn_skill MAG_FOU_002`

## Lore (Encyclopédie d'Argo)
Une décharge courte à bout portant, discrète et sans incantation visible.

## Commande IA
- `SYS_GRANT_SPELL(Avatar_ID, 'MAG_FOU_002')`
