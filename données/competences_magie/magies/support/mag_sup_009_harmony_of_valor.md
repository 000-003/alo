...
## Incantation
*Le joueur tape `!cast harmony_of_valor` pour lancer le sort.*

## Acquisition (Enseignement)
- **Enseignant** : Conservatoire Puca d’Alne, maître Zephyrine `NPC_ALN_68`
- **Prix d'apprentissage** : 6500 Yrds (≈ 50 % d’un équipement T4)
- **Commande** : `!learn_skill MAG_SUP_009`

## Lore (Encyclopédie d'Argo)
Une harmonie de bravoure qui décuple brièvement toutes les statistiques du groupe.

## Commande IA
- `SYS_GRANT_SPELL(Avatar_ID, 'MAG_SUP_009')`
