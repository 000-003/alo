...
## Incantation
*Le joueur tape `!cast haste` pour lancer le sort.*

## Acquisition (Enseignement)
- **Enseignant** : Conservatoire Puca d’Alne, maître Zephyrine `NPC_ALN_68`
- **Prix d'apprentissage** : 150 Yrds (≈ 50 % d’un équipement T1)
- **Commande** : `!learn_skill MAG_SUP_002`

## Lore (Encyclopédie d'Argo)
Un tempo accéléré qui augmente la vitesse d’action d’un allié.

## Commande IA
- `SYS_GRANT_SPELL(Avatar_ID, 'MAG_SUP_002')`
