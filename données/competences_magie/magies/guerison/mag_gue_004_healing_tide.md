...
## Incantation
*Le joueur tape `!cast healing_tide` pour lancer le sort.*

## Acquisition (Enseignement)
- **Enseignant** : Sanctuaire de Guérison d’Alne, maître Selene `NPC_ALN_70`
- **Prix d'apprentissage** : 500 Yrds (≈ 50 % d’un équipement T2)
- **Commande** : `!learn_skill MAG_GUE_004`

## Lore (Encyclopédie d'Argo)
Une marée bienfaisante qui soigne tous les alliés d’une petite zone ; fierté de l’Archipel.

## Commande IA
- `SYS_GRANT_SPELL(Avatar_ID, 'MAG_GUE_004')`
