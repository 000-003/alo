...
## Acquisition
- **Enseignant** : Magni, Marchand Leprechaun `NPC_BRO_02`
- **Prix d'apprentissage** : 250 Yrds
- **Commande** : `!learn_skill PAS_SOC_010`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
La scène est un champ de bataille où les mots sont les seules armes permises.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_SOC_010')`
