...
## Acquisition
- **Enseignant** : Opaline, Sculptrice de Lioda `NPC_LIO_06`
- **Prix d'apprentissage** : 250 Yrds
- **Commande** : `!learn_skill PAS_CRA_025`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
La statue dort dans le marbre ; le sculpteur libère ce qui est déjà là.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CRA_025')`
