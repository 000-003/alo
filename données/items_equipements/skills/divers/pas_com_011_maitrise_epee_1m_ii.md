...
## Acquisition
- **Enseignant** : Brok, Chasseur Cait Sith `NPC_FRE_07`
- **Prix d'apprentissage** : 1 000 Yrds
- **Commande** : `!learn_skill PAS_CBT_011`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Trancher avec une épée courte demande un sens du rythme que les lourdes armes n'enseignent pas.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_011')`
