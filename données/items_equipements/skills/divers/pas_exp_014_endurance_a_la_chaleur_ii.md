...
## Acquisition
- **Enseignant** : Finbar, Plongeur Undine `NPC_UND_02`
- **Prix d'apprentissage** : 1 000 Yrds
- **Commande** : `!learn_skill PAS_EXP_014`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Les mirages dansent devant les yeux de ceux qui ne supportent pas le soleil brûlant.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_EXP_014')`
