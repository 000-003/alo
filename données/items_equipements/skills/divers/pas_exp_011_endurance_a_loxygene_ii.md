...
## Acquisition
- **Enseignant** : Chênevert, Glaneur de Swilvane `NPC_SWI_02`
- **Prix d'apprentissage** : 1 000 Yrds
- **Commande** : `!learn_skill PAS_EXP_011`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Respirer lentement, économiser chaque bulle : la clé des abysses.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_EXP_011')`
