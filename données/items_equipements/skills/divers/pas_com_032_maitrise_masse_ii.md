...
## Acquisition
- **Enseignant** : Kagemune, Vétéran de Gattan `NPC_GAT_03`
- **Prix d'apprentissage** : 1 000 Yrds
- **Commande** : `!learn_skill PAS_CBT_032`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Le bruit sourd d'une masse sur un bouclier annonce la défaite imminente de celui qui le porte.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_032')`
