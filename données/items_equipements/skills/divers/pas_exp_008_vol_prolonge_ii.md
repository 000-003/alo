...
## Acquisition
- **Enseignant** : Aldric, Guide d'Alne `NPC_ALN_05`
- **Prix d'apprentissage** : 1 000 Yrds
- **Commande** : `!learn_skill PAS_EXP_008`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Planer au-dessus des nuages demande un courage que même certains Sylphes n'ont pas.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_EXP_008')`
