...
- **Commande** : `!learn_skill PAS_CRA_023`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Assembler une armure est un puzzle mortel où chaque pièce doit protéger sans entraver.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CRA_023')`
