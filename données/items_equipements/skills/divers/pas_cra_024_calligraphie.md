...
## Acquisition
- **Enseignant** : Ombrelle, Calligraphe de Duskarn `NPC_DUS_05`
- **Prix d'apprentissage** : 250 Yrds
- **Commande** : `!learn_skill PAS_CRA_024`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
L'encre coule et les runes prennent vie ; la calligraphie est la danse silencieuse du savoir.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CRA_024')`
