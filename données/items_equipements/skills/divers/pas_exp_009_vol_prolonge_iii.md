...
## Acquisition
- **Enseignant** : Kira, Pisteur de Freelia `NPC_FRE_06`
- **Prix d'apprentissage** : 4 000 Yrds
- **Commande** : `!learn_skill PAS_EXP_009`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Quand vos ailes rencontrent le vent éternel, la terre n'est plus qu'un souvenir.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_EXP_009')`
