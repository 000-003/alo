...
## Acquisition
- **Enseignant** : Magni, Forgeron Leprechaun `NPC_BRO_01`
- **Prix d'apprentissage** : 250 Yrds
- **Commande** : `!learn_skill PAS_CBT_040`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
L'éclair frappe sans prévenir ; seuls les sages apprennent à ne pas être là où il tombe.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_040')`
