...
## Acquisition
- **Enseignant** : Mithrandur, Gardien Gnome `NPC_GNO_04`
- **Prix d'apprentissage** : 1 000 Yrds
- **Commande** : `!learn_skill PAS_CBT_014`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Le poids de la lame devient un avantage quand on sait le faire tourner en momentum.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_014')`
