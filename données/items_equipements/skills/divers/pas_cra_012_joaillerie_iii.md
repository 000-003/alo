...
## Acquisition
- **Enseignant** : Sylfia, Artisane de Swilvane `NPC_SWI_07`
- **Prix d'apprentissage** : 4 000 Yrds
- **Commande** : `!learn_skill PAS_CRA_012`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Le joaillier légendaire voit l'âme de la gemme avant même de la toucher.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CRA_012')`
