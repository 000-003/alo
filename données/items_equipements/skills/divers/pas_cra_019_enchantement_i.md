...
## Acquisition
- **Enseignant** : Marin, Chef Undine `NPC_UND_04`
- **Prix d'apprentissage** : 250 Yrds
- **Commande** : `!learn_skill PAS_CRA_019`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
La magie est déjà dans les choses ; l'enchantement ne fait que la réveiller.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CRA_019')`
