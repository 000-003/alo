...
## Acquisition
- **Enseignant** : Lunette, Ambassadrice Cait Sith `NPC_FRE_04`
- **Prix d'apprentissage** : 4 000 Yrds
- **Commande** : `!learn_skill PAS_SOC_012`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Le barde légendaire fait pleurer les pierres et rire les ombres.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_SOC_012')`
