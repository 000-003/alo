...
- **Commande** : `!learn_skill PAS_CRA_016`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Le bois vivant ne se laisse pas dompter ; il faut le comprendre pour le travailler.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CRA_016')`
