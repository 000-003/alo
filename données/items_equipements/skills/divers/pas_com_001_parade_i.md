...
## Acquisition
- **Enseignant** : Aldric, Maître d'Armes d'Alne `NPC_ALN_01`
- **Prix d'apprentissage** : 250 Yrds
- **Commande** : `!learn_skill PAS_CBT_001`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Un soldat qui sait parer vit assez longtemps pour apprendre à frapper.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_001')`
