...
## Acquisition
- **Enseignant** : Fitz, Tactitien de Lioda `NPC_LIO_02`
- **Prix d'apprentissage** : 1 000 Yrds
- **Commande** : `!learn_skill PAS_CBT_005`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
L'esquive n'est pas une fuite mais un repositionnement ; le vent ne combat pas le rocher, il le contourne.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_005')`
