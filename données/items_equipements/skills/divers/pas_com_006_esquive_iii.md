...
## Acquisition
- **Enseignant** : Sylfia, Danseuse de Lame de Swilvane `NPC_SWI_03`
- **Prix d'apprentissage** : 4 000 Yrds
- **Commande** : `!learn_skill PAS_CBT_006`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Danser entre les lames requiert un calme que seule la maîtrise de soi peut offrir.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_CBT_006')`
