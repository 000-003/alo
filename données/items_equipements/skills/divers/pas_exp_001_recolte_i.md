...
- **Commande** : `!learn_skill PAS_EXP_001`
- Limite d'équipement : 2 passives du même domaine max

## Lore (Encyclopédie d'Argo)
Les forêts d'Argo sont généreuses pour qui sait demander sans prendre plus que nécessaire.

## Commande IA
- `SYS_GRANT_PASSIVE(Avatar_ID, 'PAS_EXP_001')`
